...
export const SKILLS: readonly SkillDef[] = [
  // ---- Phase 1 · deterministic core + intake (read-only + profile root-dep) ----
  {
    id: INTAKE_SKILL_ID,
  ...
  },
  {
    ...
    slash: "/quote_audit",
    title: "Quote audit",
    summary: "Audit a dealer quote against deterministic rules and flag issues.",
    phase: 1,
    riskClass: "read_only",
    status: "planned",
    workflowId: null,
  ...
  },
  {
    ...
    summary: "Scan a dealer site's inventory pages for matching vehicles.",
    phase: 2,
    riskClass: "local_write",
    status: "planned",
    workflowId: null,
  ...
  },
  {
    ...
    summary: "Scan a specific inventory link for vehicle details.",
    phase: 2,
    riskClass: "local_write",
    status: "planned",
    workflowId: null,
  ...
  },
  {
    ...
    summary: "Prune stale/dead dealer rows (typed-YES second-confirm).",
    phase: 3,
  ...
  // ---- Phase 4 · orchestration / report (compose + destructive-local) ----
  {
    ...
    summary: "Compose the read-only quote skills into one pipeline run.",
    phase: 4,
    riskClass: "local_write",
    status: "planned",
    workflowId: null,
  ...
  },
  {
    ...
    summary: "Reset a profile's pipeline state (typed-YES second-confirm).",
    phase: 4,
    riskClass: "destructive",
    status: "planned",
    workflowId: null,
