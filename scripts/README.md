...
> [`../../AutoBroker-dev-plan/architecture/DECISIONS.md`](../../AutoBroker-dev-plan/architecture/DECISIONS.md)
> ("DB 驱动 + schema 迁移") and
> [`ARCH_PERSISTENCE.md`](../../AutoBroker-dev-plan/architecture/ARCH_PERSISTENCE.md).
